...
<head>
    ...
    <!-- Include All CSS -->
    <link rel="stylesheet" type="text/css" href="<?= base_url(APPNAME.'views/css/bootstrap.css') ?>"/>
    <link rel="stylesheet" type="text/css" href="<?= base_url(APPNAME.'views/css/prettyPhoto.css') ?>"/>
    <link rel="stylesheet" type="text/css" href="<?= base_url(APPNAME.'views/css/rticons.css') ?>"/>
    <link rel="stylesheet" type="text/css" href="<?= base_url(APPNAME.'views/css/settings.css') ?>"/>
    <link rel="stylesheet" type="text/css" href="<?= base_url(APPNAME.'views/css/font-awesome.min.css') ?>"/>
    <link rel="stylesheet" type="text/css" href="<?= base_url(APPNAME.'views/css/js-image-slider.css') ?>"/>
    <link rel="stylesheet" type="text/css" href="<?= base_url(APPNAME.'views/css/preset.css') ?>"/>
    <link rel="stylesheet" type="text/css" href="<?= base_url(APPNAME.'views/css/style.css') ?>"/>
    <link rel="stylesheet" type="text/css" href="<?= base_url(APPNAME.'views/css/responsive.css') ?>"/>
    <link rel="stylesheet" type="text/css" href="<?= base_url(APPNAME.'views/css/animate.css') ?>"/>
    ...
    <link id="colorChem" rel="stylesheet" type="text/css"
          href="<?= base_url(APPNAME.'views/css/colorpreset/light.css') ?>"/>
    <link rel="stylesheet" type="text/css" href="<?= base_url(APPNAME.'views/css/colorpreset/color3.css') ?>"/>

    <!-- Favicon Icon -->
    <link rel="icon" type="image/png" href="<?= base_url(APPNAME.'views/images/favicon.png') ?>">
    <!-- Favicon Icon -->

    <!--[if lt IE 9]>
    <script src="<?= base_url(APPNAME.'views/js/html5shiv.js')?>"></script>
    <![endif]-->
</head>
<body>
<!-- Start Loader -->
        ...
        <div class="tp-banner1">
            <ul>
                <li data-transition="slotslide-horizontal" data-slotamount="7" data-masterspeed="1000">
                    <img src="<?= base_url(APPNAME.'views/images/home1/slider3.jpg') ?>" alt="slidebg1" data-bgfit="cover"
                    ...
                    <div class="tp-caption lightgrey_divider lft fadeout resFix"
                        ...
                        <div class="sliderImg three">
                            <img src="<?= base_url(APPNAME.'views/images/home3/sldCap3.png')?>" alt="ThemeWar">
                        </div>
                    </div>
                </li>
                <li data-transition="boxslide" data-slotamount="7" data-masterspeed="1000">
                    <img src="<?= base_url(APPNAME.'views/images/home1/slider1.jpg')?>" alt="slidebg1" data-bgfit="cover" data-bgposition="left top"
                    ...
                    <div class="tp-caption lightgrey_divider lft fadeout resFix"
                         ...
                         data-easing="easeOutBack">
                        <div class="sliderImg">
                            <img src="<?= base_url(APPNAME.'views/images/home1/sldCap1.png')?>" alt="ThemeWar">
                        </div>
                    </div>
                </li>
                <li data-transition="curtain-3" data-slotamount="7" data-masterspeed="1000">
                    <img src="<?= base_url(APPNAME.'views/images/home1/slider2.jpg')?>" alt="slidebg1" data-bgfit="cover" data-bgposition="left top"
                         data-bgrepeat="no-repeat">
                    <div class="tp-caption lightgrey_divider lft fadeout"
                         data-x="left"
                         data-y="235"
                    ...
                    <div class="tp-caption lightgrey_divider lft fadeout resFix"
                        ...
                        <div class="sliderImg two">
                            <img src="<?= base_url(APPNAME.'views/images/home2/sldCap2.png')?>" alt="ThemeWar">
                        </div>
                    </div>
                </li>
            </ul>
...
<!--                        <h2>People<img class="testiImg" src="--><?//= base_url(APPNAME.'views/images/logoBig.png')?><!--" alt="">Top<span>Biz</span></h2>-->
<!--                    </div>-->
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 col-xs-12 text-center wow fadeInUp" data-wow-duration="700ms"
                    ...
                    <div class="featureImg">
                        <img src="<?= base_url(APPNAME.'views/images/home1/feature1.png')?>" alt="">
                    </div>
                ...
                <div class="col-lg-3 col-sm-6 col-xs-12 text-center wow fadeInUp" data-wow-duration="700ms"
                    ...
                    <div class="featureImg">
                        <img src="<?= base_url(APPNAME.'views/images/home1/feature2.png')?>" alt="">
                    </div>
                    <div class="featureContent">
                ...
                <div class="col-lg-3 col-sm-6 col-xs-12 text-center wow fadeInUp" data-wow-duration="700ms"
                    ...
                    <div class="featureImg">
                        <img src="<?= base_url(APPNAME.'views/images/home1/feature3.png')?>" alt="">
                    </div>
                    <div class="featureContent">
                ...
                <div class="col-lg-3 col-sm-6 col-xs-12 text-center wow fadeInUp" data-wow-duration="700ms"
                    ...
                    <div class="featureImg">
                        <img src="<?= base_url(APPNAME.'views/images/home1/feature4.png')?>" alt="">
                    </div>
                    <div class="featureContent">
...
<!--                        <img src="--><?//= base_url(APPNAME.'views/images/home1/mobile.png')?><!--" alt="">-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                        <div class="folioImg2">-->
<!--                            <img src="--><?//= base_url(APPNAME.'views/images/home3/folio2.jpg')?><!--" alt="">-->
<!--                            <div class="folioHover2">-->
<!--                                <a href="--><?//= base_url(APPNAME.'views/images/home3/folio2.jpg')?><!--" class="prePhoto2" data-rel="prettyPhoto"><i-->
<!--                                        class="icon-search3"></i></a>-->
...
<!--                    <div class="col-lg-4 col-sm-4 col-xs-12 text-center mix shop">-->
<!--                        <div class="folioImg2">-->
<!--                            <img src="--><?//= base_url(APPNAME.'views/images/home3/folio3.jpg')?><!--" alt="">-->
<!--                            <div class="folioHover2">-->
<!--                                <a href="--><?//= base_url(APPNAME.'views/images/home3/folio3.jpg')?><!--" class="prePhoto2" data-rel="prettyPhoto"><i-->
<!--                                        class="icon-search3"></i></a>-->
<!--                                <a href="folio1.html" class="detailsLink2"><i class="icon-location"></i></a>-->
<!--                            </div>-->
<!--                        </div>-->
...
<!--                    <div class="col-lg-4 col-sm-4 col-xs-12 text-center mix company">-->
<!--                        <div class="folioImg2">-->
<!--                            <img src="--><?//= base_url(APPNAME.'views/images/home3/folio4.jpg')?><!--" alt="">-->
<!--                            <div class="folioHover2">-->
<!--                                <a href="--><?//= base_url(APPNAME.'views/images/home3/folio4.jpg')?><!--" class="prePhoto2" data-rel="prettyPhoto"><i-->
<!--                                        class="icon-search3"></i></a>-->
<!--                                <a href="folio1.html" class="detailsLink2"><i class="icon-location"></i></a>-->
<!--                            </div>-->
<!--                        </div>-->
...
<!--                        <div class="folioImg2">-->
<!--                            <img src="--><?//= base_url(APPNAME.'views/images/home3/folio5.jpg')?><!--" alt="">-->
<!--                            <div class="folioHover2">-->
<!--                                <a href="--><?//= base_url(APPNAME.'views/images/home3/folio5.jpg')?><!--" class="prePhoto2" data-rel="prettyPhoto"><i-->
<!--                                        class="icon-search3"></i></a>-->
<!--                                <a href="folio1.html" class="detailsLink2"><i class="icon-location"></i></a>-->
<!--                            </div>-->
<!--                        </div>-->
...
<!--                    <div class="col-lg-4 col-sm-4 col-xs-12 text-center mix realestate">-->
<!--                        <div class="folioImg2">-->
<!--                            <img src="--><?//= base_url(APPNAME.'views/images/home3/folio6.jpg')?><!--" alt="">-->
<!--                            <div class="folioHover2">-->
<!--                                <a href="--><?//= base_url(APPNAME.'views/images/home3/folio6.jpg')?><!--" class="prePhoto2" data-rel="prettyPhoto"><i-->
<!--                                        class="icon-search3"></i></a>-->
<!--                                <a href="folio1.html" class="detailsLink2"><i class="icon-location"></i></a>-->
<!--                            </div>-->
<!--                        </div>-->
...
<!--                            <img src="--><?//= base_url(APPNAME.'views/images/home1/blog1.jpg')?><!--" alt="">-->
<!--                            <div class="postDate">-->
<!--                                <h1>18</h1>-->
<!--                                <p>October</p>-->
<!--                                <a href="#">7 comments</a>-->
...
<!--                            <img src="--><?//= base_url(APPNAME.'views/images/home1/blog2.jpg')?><!--" alt="">-->
<!--                            <div class="postDate">-->
<!--                                <h1>09</h1>-->
<!--                                <p>October</p>-->
<!--                                <a href="#">5 comments</a>-->
...
<!--                        <div class="postThumb right">-->
<!--                            <img src="--><?//= base_url(APPNAME.'views/images/home1/blog3.jpg')?><!--" alt="">-->
<!--                            <div class="postDate">-->
<!--                                <h1>02</h1>-->
<!--                                <p>October</p>-->
...
<!--================= Box Div End ==================-->
<!--================= Back To Top ==================-->
<!--<a href="#" id="backto"><img src="--><?//= base_url(APPNAME.'views/images/backto.png')?><!--" alt=""></a>-->

<!-- Include All JS -->
<script type="text/javascript" src="<?= base_url(APPNAME.'views/js/jquery.js')?>"></script>
<script type="text/javascript" src="<?= base_url(APPNAME.'views/js/bootstrap.js')?>"></script>
<script type="text/javascript" src="<?= base_url(APPNAME.'views/js/jquery.prettyPhoto.js')?>"></script>
<script type="text/javascript" src="<?= base_url(APPNAME.'views/js/mixer.js')?>"></script>
<script type="text/javascript" src="<?= base_url(APPNAME.'views/js/appear.js')?>"></script>
<script type="text/javascript" src="<?= base_url(APPNAME.'views/js/circle-progress.js')?>"></script>
<script type="text/javascript" src="<?= base_url(APPNAME.'views/js/modernizr.custom.js')?>"></script>
<script type="text/javascript" src="<?= base_url(APPNAME.'views/js/directionHover.js')?>"></script>
<script type="text/javascript" src="<?= base_url(APPNAME.'views/js/js-image-slider.js')?>"></script>
<script type="text/javascript" src="<?= base_url(APPNAME.'views/js/jquery.themepunch.tools.min.js')?>"></script>
<script type="text/javascript" src="<?= base_url(APPNAME.'views/js/jquery.themepunch.revolution.min.js')?>"></script>
<script type="text/javascript" src="<?= base_url(APPNAME.'views/js/wow.min.js')?>"></script>
<script type="text/javascript" src="<?= base_url(APPNAME.'views/js/theme.js')?>"></script>
</body>
</html>
